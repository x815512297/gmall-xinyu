...
public class CategoryController {
    ...
    @GetMapping
    public Resp<List<CategoryEntity>> queryCategoryByCidOrlevel(@RequestParam(value = "level",defaultValue = "0")Integer level
            ,@RequestParam(value = "parentCid",required = false)Long parentCid){

        List<CategoryEntity> categoryEntities= this.categoryService.queryCategoryByCidOrlevel(level,parentCid);
